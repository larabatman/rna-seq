...
TRIMMED_FASTQC_RESULTS_DIR="/data/users/${USER}/rna_seq/fastQC_results/fastQC_reports"
MULTIQC_OUTPUT_DIR="/data/users/${USER}/rna_seq/multiQC_trimmed_results"
...
multiqc $TRIMMED_FASTQC_RESULTS_DIR -o $MULTIQC_OUTPUT_DIR --interactive --title "MultiQC Report - Trimmed Data"
